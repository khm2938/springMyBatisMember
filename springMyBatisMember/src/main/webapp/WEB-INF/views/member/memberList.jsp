...
<div class="container">
    ...
    <div class="search-container">
        <form action="/member/memberList" method="get" class="search-form">
    ...
    <div class="btn-area">
        <a href="/member/memberList" class="btn-write">회원목록</a>
        <a href="/member/insertForm" class="btn-write">회원등록</a>
    </div>
</div>
